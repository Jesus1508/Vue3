...
describe('projects store', () => {
    ...
    test('should return default values', () => {
        ...
        expect(projectWithCompletion).toEqual([]);
    ...
    test('should load from localStorage', () => {
        ...
        // expect(project1).toEqual(localProjects.at(0));
        // expect(project2).toEqual(localProjects.at(1));
    ...
    test('add a task to project', () => {
        ...
        store.addTaskProject(project.id, taskName);
